...
export DISPLAY_NAME="dog_breed_training_single_gpu_job_$UUID"
...
#export CMDARGS="--model_name=InceptionResNetV2_finetuning,--epochs=30,--batch_size=32,--wandb_key=$WANDB_KEY" 
